...
function CountdownTimer() {
  ...
  const targetDate = useMemo(() => new Date("September 17, 2026 17:00:00").getTime(), []);
  ...
  return (
    <section
      ref={ref}
      className="relative py-24 md:py-36 bg-gradient-to-br from-[#fdfaf5] via-white to-[#f5e6c8] flex flex-col items-center overflow-hidden z-20"
    >
      {/* Texture & Glow Layer */}
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(212,175,55,0.15),transparent_70%)] pointer-events-none z-0" />
      ...
      <div className="w-full max-w-6xl px-6 flex flex-col items-center text-center relative z-10">
        ...
        >
          <motion.div
            ...
            className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#d4af37]/45 bg-white/60 px-5 py-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.05)] backdrop-blur-md"
          >
            <Sparkles className="h-4 w-4 text-[#d4af37]" />
            <span className="text-xs font-bold uppercase tracking-[0.24em] text-[#8b0000] sm:text-sm">
              The Big Day Approaches
            </span>
            <Sparkles className="h-4 w-4 text-[#d4af37]" />
          </motion.div>

          <h2 className="font-alex text-6xl md:text-[8rem] leading-tight text-[#8b0000] drop-shadow-sm">
          ...
          <p className="mx-auto mt-10 max-w-2xl text-slate-600 font-montserrat tracking-[0.3em] text-[10px] md:text-xs uppercase font-bold">
            Every second brings us closer to our blessed wedding day. We cannot wait to celebrate this grace-filled moment with you.
          </p>
        </motion.div>

        <div className="w-full rounded-[2.5rem] border border-[#d4af37]/30 bg-white/40 p-4 shadow-[0_30px_90px_rgba(0,0,0,0.05)] backdrop-blur-2xl sm:p-6 md:p-8">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-8">
            {countdownItems.map((item, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-[2rem] border border-[#d4af37]/15 bg-white/60 p-6 shadow-[0_15px_35px_rgba(0,0,0,0.05)] transition-all duration-300 group-hover:border-[#d4af37]/40 group-hover:bg-white/80 md:p-8">
                  ...
                  <div className="absolute -right-6 -top-6 h-20 w-20 rounded-full border border-[#d4af37]/40" />
                  <div className="absolute -left-6 -bottom-6 h-16 w-16 rounded-full border border-[#d4af37]/30" />
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center text-center">
                    <div className="relative flex h-[64px] w-full items-center justify-center overflow-hidden sm:h-[78px] md:h-[96px]">
                      <AnimatePresence mode="popLayout">
                        <motion.span
                          ...
                          className="absolute font-serif text-5xl font-semibold text-[#8b0000] drop-shadow-[0_2px_4px_rgba(0,0,0,0.1)] sm:text-6xl md:text-7xl"
                        >
                    ...
                    <div className="mt-3 rounded-full border border-[#d4af37]/40 bg-white/80 px-3 py-1.5 shadow-sm md:mt-5">
        ...
        >
          <div className="flex items-center gap-3 text-[#d4af37]">
            ...
            <span className="font-serif italic text-lg text-slate-600 sm:text-2xl">
        ...
        {!isOpened ? (
          ...
          >
            <video
              ...
              className={`absolute inset-0 w-full h-full object-cover transition-all duration-1000 ${!hasStartedIntro ? "blur-md scale-105" : "blur-0 scale-100"}`}
            >
            ...
            {!hasStartedIntro && (
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/20 backdrop-blur-sm">
                <motion.div
                  ...
                  className="flex flex-col items-center px-4 w-full max-w-3xl"
                >
                  {guestName && (
                    <div className="mb-10 md:mb-14 flex flex-col items-center animate-in fade-in zoom-in duration-1000 delay-500">
                      <span className="font-montserrat text-white/80 text-[9px] md:text-[11px] uppercase tracking-[0.4em] mb-3">Dear</span>
                      <span className="font-alex text-4xl md:text-5xl text-[#d4af37] drop-shadow-lg text-center leading-tight px-2">
                        {guestName}
                      </span>
                    </div>
                  )}

                  <p className="font-montserrat text-white text-[8px] sm:text-[10px] md:text-[12px] uppercase tracking-[0.25em] sm:tracking-[0.4em] mb-4 md:mb-8 drop-shadow-md text-center">
                  ...
                  <button
                    ...
                    className="group relative overflow-hidden rounded-full border border-white/50 bg-white/10 px-6 py-3 md:px-8 md:py-4 backdrop-blur-md transition-all hover:bg-white/20 hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95"
                  >
                    <div className="absolute inset-0 flex h-full w-full justify-center [transform:skew(-12deg)_translateX(-150%)] group-hover:duration-1000 group-hover:[transform:skew(-12deg)_translateX(150%)]">
                      <div className="relative h-full w-8 bg-white/20" />
                    </div>
                    <span className="font-cinzel text-xs font-bold uppercase tracking-widest text-white">
                      View Invitation
                    </span>
                  </button>
                </motion.div>
          ...
          >
            ...
            <section className="relative z-10 flex min-h-[95dvh] w-full items-center justify-center overflow-hidden bg-gradient-to-br from-[#fdfaf5] via-white to-[#f5e6c8] px-4 py-12 sm:px-8 md:min-h-[100dvh]">
              ...
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                  ...
                  className="absolute top-20 left-[10%] text-[#8b0000]/10"
                >
                ...
                <motion.div
                  ...
                  className="absolute bottom-40 right-[15%] text-[#d4af37]/20"
                >
              ...
              >
                ...
                <div className="mb-6 flex items-center justify-center gap-4">
                  ...
                  <div className="animate-heartbeat">
                    <Heart className="h-5 w-5 text-[#8b0000] fill-[#8b0000]/20" />
                  </div>
                  <motion.span
                    initial={{ width: 0 }}
                    animate={{ width: isLikelyMobileOrTablet() ? 40 : 80 }}
                ...
                <h1 className="mt-6 text-center font-alex text-[2.8rem] leading-[1.1] text-[#8b0000] drop-shadow-[0_2px_8px_rgba(0,0,0,0.05)] sm:text-[4.5rem] md:text-[6.5rem] lg:text-[7.5rem]">
                  <span className="text-shimmer block">Heshani</span>
                  <div className="my-2 flex items-center justify-center gap-4">
                    <div className="h-px w-16 bg-[#8b0000]/20" />
                    <span className="font-serif text-3xl italic text-[#d4af37] sm:text-4xl md:text-5xl">&amp;</span>
                    <div className="h-px w-16 bg-[#8b0000]/20" />
                  </div>
                  <span className="text-shimmer block">Nalindra</span>
                </h1>
                ...
                >
                  <p className="font-cinzel text-xl text-[#8b0000] tracking-[0.2em]">SEP 17 | 2026</p>
                </motion.div>
                ...
                <div className="mx-auto mt-10 grid max-w-4xl gap-3 sm:grid-cols-3">
                  {[
                    { label: "Ceremony", value: "Poruwa 5.00 PM" },
                    { label: "Venue", value: "Vinrich Lake Resort" },
                    { label: "Reception", value: "6.00 PM - 11.30 PM" }
                  ].map((item, i) => (
                    <motion.div
                      key={item.label}
                      ...
                      className="group relative rounded-3xl border border-[#d4af37]/15 bg-white/60 p-4 text-center backdrop-blur-sm transition-all hover:bg-white/80 hover:border-[#d4af37]/30 shadow-sm"
                    >
                      <p className="text-[8px] uppercase tracking-[0.25em] text-[#d4af37] font-bold mb-1">{item.label}</p>
                      <p className="font-cinzel text-xs text-[#8b0000] tracking-wider sm:text-sm">{item.value}</p>
                    </motion.div>
                  ))}
                </div>
                ...
                >
                  <div className="inline-flex items-center gap-3 rounded-full border border-[#d4af37]/30 bg-white/60 px-6 py-2 backdrop-blur-md shadow-sm">
                    <Heart className="h-4 w-4 text-[#8b0000] fill-[#8b0000] animate-heartbeat" />
                    <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#8b0000]/80">SAVE THE DATE • SEP 17</span>
                    <Heart className="h-4 w-4 text-[#8b0000] fill-[#8b0000] animate-heartbeat" />
                  </div>
                </motion.div>
              </motion.div>
            ...
            <section className="relative py-24 md:py-36 w-full flex flex-col items-center overflow-hidden z-10 border-b-[0.5px] border-[#d4af37]/30 bg-[#fdfaf5]">
              ...
              <div className="max-w-[1100px] w-full flex flex-col items-center text-center relative z-20 px-6">
                ...
                >
                  ...
                  <p className="tracking-[0.4em] md:tracking-[0.7em] text-[#d4af37] text-[9px] md:text-[12px] uppercase font-montserrat font-bold drop-shadow-sm mt-3">
                  ...
                  <p className="text-slate-500 font-serif text-[15px] md:text-[22px] italic tracking-wide mt-4 mb-2 uppercase">
                ...
                <div className="relative w-full flex flex-col items-center justify-center mt-4 mb-16">
                  ...
                  <motion.div
                    ...
                    className="flex flex-col items-center text-center space-y-2 md:space-y-4 z-20 w-full max-w-3xl"
                  >
                    <div className="flex flex-col items-center text-center pt-2 md:pt-0">
                      <span className="font-montserrat text-[8px] md:text-[9px] tracking-[0.35em] text-[#d4af37] uppercase font-bold mb-1.5">
                        Loving Daughter Of
                      </span>
                      <span className="font-cinzel text-[10px] md:text-[13px] text-slate-700 tracking-[0.15em] font-bold uppercase drop-shadow-sm">
                        Mr. A.J. Perera <span className="text-[#d4af37] font-serif italic font-normal text-sm px-1">&</span> Mrs. C.I.D. Silva
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-4 w-full justify-center px-4 md:px-12 py-2 md:py-4">
                      <div className="h-[0.5px] flex-1 max-w-[80px] bg-[#d4af37]/40" />
                      <span className="font-serif text-2xl md:text-5xl text-[#d4af37]/80 italic font-light">&</span>
                      <div className="h-[0.5px] flex-1 max-w-[80px] bg-[#d4af37]/40" />
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center pt-2">
                      ...
                      <span className="font-cinzel text-[10px] md:text-[13px] text-slate-700 tracking-[0.15em] font-bold uppercase drop-shadow-sm">
                        Mr. N.J. Kulathunga <span className="text-[#d4af37] font-serif italic font-normal text-sm px-1">&</span> Mrs. L. R. Fernando
                      </span>
                    </div>

                    <div className="w-full flex justify-center overflow-hidden">
                      <h3 className="text-[3.5rem] sm:text-6xl md:text-[8rem] lg:text-[9rem] font-alex text-gold-gradient leading-none drop-shadow-sm px-2 pt-1 pb-4">
                        Nalindra
                      </h3>
                    </div>
                    
                    <p className="mt-8 text-center text-slate-500 font-montserrat text-[9px] md:text-xs uppercase tracking-[0.2em] font-medium leading-relaxed max-w-2xl px-4">
                      Your presence and blessings will make this joyous occasion even more special.
                    </p>
                  </motion.div>
                </div>
              </div>
            ...
            <section className="relative py-24 md:py-36 bg-[#fdfaf5] overflow-hidden">
              ...
              <div className="container mx-auto px-6 max-w-6xl relative z-10">
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 mb-2">
                        <div className="w-12 h-[1px] bg-[#8b0000]" />
                        <span className="text-[#d4af37]">✦</span>
                        <span className="text-[#8b0000] font-bold uppercase tracking-[0.4em] text-[10px]">
                          T H E | V E N U E
                        </span>
                      </div>
                      <h2 className="font-cinzel text-[2.5rem] md:text-[4rem] text-[#8b0000] leading-tight tracking-widest font-bold uppercase">
                        Vinrich Lake Resort
                      </h2>
                      <p className="font-playball text-3xl md:text-5xl text-[#8b0000] italic mt-2">
                        Hall - Lakewood chateau
                      </p>
                    </div>

                    <div className="space-y-8 pl-6 border-l border-[#d4af37]/40">
                      <div className="flex items-start gap-4">
                        <MapPin className="w-5 h-5 text-[#8b0000] mt-1 shrink-0" />
                        <p className="text-lg md:text-xl text-[#8b0000] font-cinzel leading-relaxed tracking-wide uppercase">
                          Vinrich Lake Resort, Hall - Lakewood chateau.
                        </p>
                      </div>
                      <p className="text-[#8b0000]/70 text-sm md:text-base tracking-widest uppercase font-light leading-loose">
                        (Poruwa ceremony at 5.00 p.m) THURSDAY, SEPTEMBER 17 2026. From 6.00 p.m to 11.30 p.m
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button
                        onClick={() =>
                          window.open("https://www.google.com/maps/search/?api=1&query=Vinrich+Lake+Resort", "_blank")
                        }
                        className="group relative inline-flex items-center justify-center gap-4 px-10 py-5 bg-[#8b0000] text-white text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] overflow-hidden transition-all hover:bg-[#6b0000]"
                      >
                  ...
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="relative w-full aspect-[3/4] max-w-[450px] mx-auto bg-white p-3 shadow-[0_40px_80px_-20px_rgba(139,0,0,0.2)] border border-[#d4af37]/50"
                  >
                    <div className="absolute inset-2 border-[0.5px] border-[#8b0000]/30 pointer-events-none z-20" />
                    <div className="w-full h-full overflow-hidden bg-white relative">
                      <iframe
                        src="https://maps.google.com/maps?q=Vinrich%20Lake%20Resort&t=&z=16&ie=UTF8&iwloc=&output=embed"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        allowFullScreen
                  ...
                  >
                    ...
                    <div className="w-full flex flex-col items-center mt-6 relative z-10 px-2 md:px-6">
                      <p className="font-montserrat text-[10px] md:text-[11px] tracking-[0.2em] text-slate-500 uppercase font-medium mb-2 text-center leading-relaxed">
                        RSVP - Heshani 074 211 9597 | Nalindra 076 573 9597
                      </p>
            ...
            <div className="relative bg-[#fdfaf5]">
              ...
              <section className="relative py-24 md:py-36 flex flex-col items-center overflow-hidden">
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#d4af37]/10 mb-8 mt-4 shadow-sm border border-[#d4af37]/20">
                      <Sparkles className="w-8 h-8 text-[#d4af37]" />
                    </div>

                    <h2 className="font-script text-[4.5rem] sm:text-[5rem] md:text-[7rem] text-[#d4af37] mb-6 drop-shadow-sm leading-none">
                      Best Wishes
                    </h2>
                    <div className="h-px w-24 bg-[#d4af37] mb-8" />

                    <p className="text-slate-600 text-sm md:text-lg leading-relaxed max-w-xl mx-auto mb-16 font-serif tracking-[0.1em] px-4 uppercase font-bold">
                    ...
                    <div className="w-full max-w-2xl mx-auto bg-white p-8 md:p-14 shadow-[0_30px_70px_-15px_rgba(212,175,55,0.1)] border border-[#d4af37]/50 relative group card-marble">
                      <div className="absolute inset-0 gold-foil-edge opacity-20 pointer-events-none" />
                      <div className="absolute inset-2 border-[0.5px] border-[#d4af37]/30 pointer-events-none transition-colors duration-700" />

                      <form className="space-y-12 text-left relative z-10" onSubmit={handleWishSubmit}>
                        <div className="space-y-4">
                          <label className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#d4af37]">
                            From
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full bg-transparent border-b border-[#d4af37]/40 px-0 py-4 text-slate-700 placeholder:text-slate-300 focus:outline-none focus:border-[#d4af37] transition-all font-cinzel text-lg tracking-widest"
                            required
                          />
                        </div>
                        <div className="space-y-4">
                          ...
                          <textarea
                            ...
                            className="w-full bg-transparent border-b border-[#d4af37]/40 px-0 py-4 text-slate-700 placeholder:text-slate-300 focus:outline-none focus:border-[#d4af37] transition-all font-cinzel text-lg tracking-widest resize-none"
                            required
                          />
                        </div>
                        ...
                        <div className="pt-6 flex justify-center">
                          <button
                            ...
                            className="bg-[#d4af37] text-white px-12 py-5 font-bold uppercase tracking-[0.4em] text-[10px] hover:bg-[#b88d1b] transition-all duration-300 shadow-md disabled:opacity-70"
                          >
              ...
              <footer className="relative py-24 md:py-32 bg-marble-theme w-full flex flex-col items-center overflow-hidden z-20">
                {/* Subtle vignette over the red theme */}
                ...
                <div className="w-full max-w-4xl px-6 flex flex-col items-center text-center relative z-20">
                  ...
                  >
                    ...
                    <p className="font-montserrat text-[9px] md:text-[11px] tracking-[0.5em] text-[#f7e7ce]/90 uppercase font-medium mb-4">
                  ...
                  <div className="mt-20 pt-8 border-t-[0.5px] border-[#d4af37]/30 w-full max-w-xs md:max-w-md flex flex-col items-center gap-4">
                    ...
                    <p className="text-[#d4af37]/80 text-[8px] md:text-[9px] mt-6 font-montserrat tracking-[0.3em] uppercase text-center max-w-[280px] md:max-w-none leading-relaxed">
                      Want a beautiful wedding website like this? <br className="md:hidden" />Create yours with <a target="_blank" rel="noreferrer" className="text-[#f7e7ce] hover:text-white underline transition-colors font-bold" href="https://wa.me/94707819074">invitemint</a>
                    </p>
                  </div>
                </div>
              </footer>
...
function AdminPanel({ isStandalone = false }: { isStandalone?: boolean }) {
  ...
  return (
    <div className={isStandalone ? "w-full max-w-sm bg-white border border-[#d4af37]/30 rounded-2xl shadow-[0_30px_70px_-15px_rgba(212,175,55,0.15)] p-6 md:p-8 font-montserrat" : "fixed top-4 left-4 z-[200] max-w-sm w-full bg-white/90 backdrop-blur-xl border border-[#d4af37]/30 rounded-2xl shadow-2xl p-6 font-montserrat animate-in fade-in slide-in-from-left-4 duration-500"}>
      <div className="flex items-center justify-between mb-6">
        <h2 className="font-cinzel font-bold text-slate-800 text-sm tracking-widest uppercase">
          Invitation Manager
        </h2>
        {!isStandalone && (
          <button
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-700 focus:outline-none focus:ring-1 focus:ring-[#d4af37]"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-[#8b0000] text-white py-3 rounded-xl font-bold text-[10px] tracking-widest uppercase hover:bg-[#6b0000] transition-all shadow-md"
        >
        ...
        {generatedLink && (
          <div className="mt-4 space-y-4">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex flex-col gap-2">
              <p className="text-[9px] text-slate-500 break-all font-mono">{generatedLink}</p>
              <button
                onClick={() => {
                ...
                className="flex items-center justify-center gap-2 bg-[#d4af37]/10 text-[#8b0000] py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-[#d4af37]/20 transition-all"
              >
                {copyStatus === "link" ? "Copied!" : "Copy Link Only"}
              </button>
            </div>
            
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex flex-col gap-2">
              <p className="text-[9px] text-slate-500 whitespace-pre-wrap font-mono max-h-32 overflow-y-auto">{generatedMessage}</p>
              <button
                onClick={() => {
                ...
                className="flex items-center justify-center gap-2 bg-[#d4af37]/10 text-[#8b0000] py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-[#d4af37]/20 transition-all"
              >
                {copyStatus === "message" ? "Copied!" : "Copy Full Message"}
              </button>
            </div>
          </div>
        )}
      ...
      <p className="mt-4 text-[9px] text-slate-400 leading-relaxed text-center">
...
export default function App() {
  ...
  if (isAdminPage) {
    return (
      <div className="min-h-screen w-full bg-[#fdfaf5] flex flex-col items-center justify-center p-4">
        <div className="absolute inset-0 opacity-[0.15] bg-[url('https://www.transparenttextures.com/patterns/natural-paper.png')] pointer-events-none z-0" />
